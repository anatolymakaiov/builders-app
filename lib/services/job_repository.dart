...
class JobRepository {
  ...
  Future<void> applyToJob(String jobId, String userId) async {
    ...
    await _db.collection('applications').add({
      "jobId": jobId,
      "workerId": userId,       // ✅ FIX
      "employerId": employerId, // ✅ КЛЮЧЕВОЕ
      "status": "pending",      // ✅ единый статус
  ...
  Future<void> toggleSaveJob(
      String userId, String jobId, bool isSaved) async {
    final ref = _db
