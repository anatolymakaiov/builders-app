...
| Worker CV | About, experience years/months and details, permits, qualifications, certifications, education, previousWork, references | users | Complete, including dynamic reference editor and legacy values |
...
| Contacts | worker/employer profiles: phone, phones, contactPerson, email, website, contacts | users | Complete for the existing mobile-editable fields; structured contacts are preserved and displayed |
| Company vacancies | employer_profile_screen | constrained jobs query | Complete: list opens role-permitted vacancy details |
